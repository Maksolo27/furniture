...
docker build -t order:2.0 -f services/order/Dockerfile services/order/
docker build -t order-migrations:2.0 -f services/order/Dockerfile.migration services/order
