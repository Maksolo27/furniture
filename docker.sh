...
docker build -t storage:2 -f services/storage/Dockerfile services/storage
docker build -t storage-migrations:3 -f services/storage/Dockerfile.migration services/storage
